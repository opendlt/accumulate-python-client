...
logger = logging.getLogger("AccumulateCreateTokenAccountDebug")
...
NEW_TOKEN_ACCOUNT_URL = "acc://custom-adi-name-1741948502948.acme/Tokens"
TOKEN_ISSUER_URL = "acc://ACME"
...
async def process_add_credits():
    ...
    custom_timestamp = 1739950965269906  # Replace with your own dynamic value
